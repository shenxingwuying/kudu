...
public class ITFaultTolerantScanner extends ITScannerMultiTablet {
  ...
  /**
   * Tests fault tolerant scanner by restarting the tserver server in the middle
   * of tablet scanning and verifies the scan results are as expected.
   * Notice, The fault injection at the 2nd ScanRequest or next scan request rather than
   * the first scan request.
   * @throws Exception
   */
  @Test(timeout = 100000)
