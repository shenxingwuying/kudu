...
void TabletServiceAdminImpl::AlterSchema(const AlterSchemaRequestPB* req,
  ...
  if (schema_version == req->schema_version()) {
    ...
    SchemaRefPtr req_schema_ptr(new Schema);
    ...
    SchemaRefPtr tablet_schema_ptr = replica->tablet_metadata()->schema();
...
Status TabletServiceImpl::HandleNewScanRequest(TabletReplica* replica,
  ...
  SchemaRefPtr projection_ptr(new Schema);
  ...
  const SchemaRefPtr tablet_schema_ptr = replica->tablet_metadata()->schema();
  ...
  SchemaRefPtr client_projection(new Schema(std::move(projection)));
  projection_ptr = projection_builder.BuildWithoutIds();
...
Status TabletServiceImpl::HandleScanAtSnapshot(const NewScanRequestPB& scan_pb,
  ...
  opts.projection = new Schema(projection);
