...
static const SchemaRefPtr kIntSchemaPtr(new Schema({ ColumnSchema("val", INT64) },
                               /*key_columns=*/1));
static const bool kIsDeletedReadDefault = false;
static const SchemaRefPtr kIntSchemaWithVColPtr(new Schema({ ColumnSchema("val", INT64),
...
TEST(TestPredicateEvaluatingIterator, TestPredicateEvaluationOrder) {
  SchemaRefPtr schema_ptr(new Schema({ ColumnSchema("a_int64", INT64),
