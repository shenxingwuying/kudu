...
void SegmentAllocator::SetSchemaForNextSegment(SchemaRefPtr schema,
                                               uint32_t version) {
...
Status Log::Open(LogOptions options,
  ...
  SchemaRefPtr schema_clone(new Schema(*schema.get()));
...
Log::Log(LogOptions options, LogContext ctx, SchemaRefPtr schema, uint32_t schema_version)
