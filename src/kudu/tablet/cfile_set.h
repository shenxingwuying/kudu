...
class CFileSet :
 ...
 public:
  ...
  std::unique_ptr<Iterator> NewIterator(SchemaRefPtr projection,
 ...
 private:
  ...
  SchemaRefPtr tablet_schema() const { return rowset_metadata_->tablet_schema(); }
...
class CFileSet::Iterator : public ColumnwiseIterator {
 ...
 private:
  ...
  Iterator(std::shared_ptr<CFileSet const> base_data, SchemaRefPtr projection,
           const fs::IOContext* io_context)
